...
$padre = mysqli_query($con, "SELECT * FROM user_tipo ") or die('query failed');
...
<?php while($pa = mysqli_fetch_assoc($padre)){ ?>
                  <option value="<?php echo $pa['id_u']; ?>"><?php echo $pa['tipo']; ?></option>
    <?php  } ?> 
              </select>
    </div>
  </div><br>
...
<input type="button" class="btn btn-success" value="Registrar usuario" onclick="registrar()">
